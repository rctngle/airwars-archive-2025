...
$lang = $args['lang'];
$belligerents_label = $args['belligerents_label'];

// $civcas_min = $args['grading_stats']['civcas_min'];
// $civcas_max = $args['grading_stats']['civcas_max'];
$countries_label = $args['grading_stats']['countries_label'];

$grading_stats = $args['grading_stats']['stats'];
$country_slug = dict_keyify($args['grading_stats']['country_slug']);

$belligerent_stats = $args['belligerent_stats'];
$strike_status_stats = $args['strike_status_stats'];
...
<section class="gradings-breakdown">
	<div class="content">			
		<div class="full">
			<div class="top">
				<div class="airwars">
					<h3>
						<?php echo dict('airwars_estimate_of_civilian_deaths_'.$country_slug); ?>

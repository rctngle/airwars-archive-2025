...
export default class Credibles extends React.Component {
	...
	getIncidents() {
		return (this.state.term && this.state.hasResults && this.state.matchedIncidents && this.state.term.length > 0) ? this.state.matchedIncidents : this.props.data.timeline.incidents;
	}
	...
	render() {
		...
		return (
			<div className={classes.join(' ')}>
				<Intro 
					numIncidents={this.props.data.timeline.incidents.length}
					civcasConceded={(this.props.data.timeline.deaths_conceded_override > 0) ? this.props.data.timeline.deaths_conceded_override : this.props.data.timeline.total_civilian_deaths_conceded_min}
					civcasAirwars={this.props.data.timeline.total_civilians_reported_killed_min}
					numNamedVictims={this.props.data.timeline.total_named_victims}
				/>

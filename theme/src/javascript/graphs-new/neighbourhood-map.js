...
function LanguageNav(props) {
	...
	return (
		<div className="langswitcher">
			<a className={(props.lang === 'en') ? 'active' : ''} href={`/conflict-data-new/civilian-casualties-in-gaza-may-10th-20th-2021/${(embedded) ? '?embedded=1' : ''}`}>English</a>
			<a className={(props.lang === 'ar') ? 'active' : ''} href={`/conflict-data-new/civilian-casualties-in-gaza-may-10th-20th-2021/?lang=ar${(embedded) ? '&embedded=1' : ''}`}>عربي</a>
			<a className={(props.lang === 'he') ? 'active' : ''} href={`/conflict-data-new/civilian-casualties-in-gaza-may-10th-20th-2021/?lang=he${(embedded) ? '&embedded=1' : ''}`}>עִברִית</a>
		</div>
	);
}
